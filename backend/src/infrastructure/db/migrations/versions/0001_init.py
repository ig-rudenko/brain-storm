...
Revision ID: 711628a716a7
Revises:
Create Date: 2025-09-22 11:12:42.114499
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("expire_at", advanced_alchemy.types.datetime.DateTimeUTC(timezone=True), nullable=False),
